...
image = cv2.imread('/Users/georgedamoulakis/PycharmProjects/Droplets/2_Images/for_MOHA/image_0.jpg',
...
#second you do this - JUST INSERT THE BEST GAMMA (first line of code)

test = adjust_gamma(image, gamma=0.5)
cv2.imwrite(f'{image_name}-gamma-sharp.jpg', test)
